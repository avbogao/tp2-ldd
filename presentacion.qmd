...
fake_news %>%
  ...
  theme(plot.title = element_text(face='bold'))
```
Podemos observar que las noticias falsas tienen mayor cantidad de signos de exclamación en el titulo que las noticias reales, además tienen mayor porcentaje de palabras 
de connotación negativa en sus titulos y estos son más cortos.